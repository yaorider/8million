...
<script type="text/javascript" src="%static_url%/js/admin/optlogcpt.js"></script>
</head>
<body>
...
<p>ログ出力設定が完了しました。</p>
<hr />
<div>[<a href="%CGI_URL%?m=optcnfmnu">機能設定メニューへ</a>]　[<a href="%CGI_URL%?m=optlogfrm">ログ出力設定画面へ</a>]</div>
</div>
</body>
</html>
