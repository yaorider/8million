...
<script type="text/javascript" src="%static_url%/js/admin/tplmaifrm.js"></script>
</head>
<body>
<h1><a href="%CGI_URL%?m=tpllstmnu">画面テンプレート</a> - 通知メール</h1>
<div id="main">
<form method="post" action="%CGI_URL%">
	<input type="hidden" name="m" value="tplmaiset" />
